...
C       Balma alfa!
        LINE_LABEL = 2
        WAVELN = 1025.72
        FNUMBER = 0.0791 ! Obtained from working backwards from scattering cross-section
        BRATIO = 0.882
        ! BRATIO = 0.118
        ABS_N2 = 0.00E+00
        ABS_O2 = 5.46E-18
...
!                 QPIVOT = BASE
! C       Ly-delta
!         ELSE IF (LINE_LABEL.EQ.4) THEN
!                 BASE   = 108.0                            
! C          exobase at 500 km
!                 QPIVOT = BASE
! C       Ly-zeta
!         ELSE IF (LINE_LABEL.EQ.6) THEN
!                 BASE   = 108.0                            
! C          exobase at 500 km
!                 QPIVOT = BASE
! C       Ly-theta
!         ELSE IF (LINE_LABEL.EQ.8) THEN
!                 BASE   = 132.0                            
! C          exobase at 524 km
!                 QPIVOT = BASE
!         END IF
